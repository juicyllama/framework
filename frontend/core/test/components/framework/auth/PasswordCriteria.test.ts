...
describe('Password Criteria', () => {
	...
	describe('character length rule', () => {
		it('shows error icon', () => {
			...
			expect(icons[0].classes()).includes('cancel')
		})
		it('shows check icon', () => {
			const authFormState: AuthFormState = {
				password: {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[0].classes()).includes('check_circle')
		})
	})
	...
	describe('capital letter rule', () => {
		it('shows error icon', () => {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[1].classes()).includes('cancel')
		})
		it('shows check icon', () => {
			const authFormState: AuthFormState = {
				password: {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[1].classes()).includes('check_circle')
		})
	})
	...
	describe('number rule', () => {
		it('shows error icon', () => {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[2].classes()).includes('cancel')
		})
		it('shows check icon', () => {
			const authFormState: AuthFormState = {
				password: {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[2].classes()).includes('check_circle')
		})
	})
	...
	describe('special character rule', () => {
		it('shows error icon', () => {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[3].classes()).includes('cancel')
		})
		it('shows check icon', () => {
			const authFormState: AuthFormState = {
				password: {
			...
			const icons = wrapper.findAll('.q-icon')
			expect(icons[3].classes()).includes('check_circle')
		})
	})
})
