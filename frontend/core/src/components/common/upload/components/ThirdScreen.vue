<template>
  <q-card-section class="q-pt-none q-pb-none">
    <div class="text-weight-bold">
      You can define the field mappings. Set mappings to specify the
      correspondence between fields in the Source and fields in the Destination.
    </div>
  </q-card-section>
  <q-card-section>
...
const targetFieldOptions = computed(() =>
  store.getFieldsPerTable(selectedTable.value)
);
