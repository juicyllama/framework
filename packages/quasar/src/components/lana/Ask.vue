...
import { JLNotice } from '@juicyllama/vue-utils'
...
<template>
	<q-card style="width: 500px; max-width: 80vw">
		<q-card-section>
			...
			<JLNotice v-if="answer?.length" type="success" :message="answer" />
			...
			<JLNotice v-if="error?.length" type="error" :message="error" />
			<JLNotice type="warning" :message="warning" />
		</q-card-section>
	</q-card>
</template>
