...
let MandateModule = exports.MandateModule = class MandateModule {
};
exports.MandateModule = MandateModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([mandate_entity_1.MollieMandate]),
        ...
        controllers: [],
        providers: [mandate_service_1.MandateService, utils_1.Logger, core_1.Query],
        exports: [mandate_service_1.MandateService],
    })
], MandateModule);
