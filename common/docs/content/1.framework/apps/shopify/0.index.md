...
The Shopify app sits on top of our [Ecommerce](../../backend/ecommerce/0.index.md) package which allows connects things like transactions automatically when you enable [crons](#crons).
