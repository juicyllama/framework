...
[Click here for a full list of the redoc options you can pass.](/framework/backend/core/utils/redoc/options)
...
As part of the JuicyLllama [core](/framework/backend/core) package we have made available a number of abstracted decorators to handle the most common CRUD operations.

-   [CRUD Decorators](/framework/backend/core/decorators/crud)
-   [Swagger Decorators](/framework/backend/core/decorators/swagger)
